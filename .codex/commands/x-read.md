...
5. If the user asks to save: write an AI-first note to `04.output/Research/X-reads/YYYY-MM-DD - <slug>.md` in the vault, following the AI-first vault rule (Section 0 of `_CLAUDE.md`):
