...
3. Infer: priority (`high` / `medium` / `low`), due date, linked project, linked person
...
6. Create a task note in `02.wiki/tasks/` if the task is substantial (more than a one-liner)
