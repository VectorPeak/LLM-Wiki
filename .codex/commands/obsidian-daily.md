...
3. Check if `02.wiki/daily/YYYY-MM-DD.md` exists for today
   - If not: read `03.templates/Daily Note.md`, fill in date fields, create the file
...
7. Check the operation log for last night's sleeptime consolidation (read yesterday's `Logs/YYYY-MM-DD.md`; if no daily log exists yet, use `.codex/references/log.md` for the log format):
