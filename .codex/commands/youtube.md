...
5. **Default save behavior: saves automatically.** AI-first note written to `04.output/Research/YouTube/YYYY-MM-DD - <video-title-slug>.md`. Frontmatter includes video ID, channel, view counts, etc. for future Dataview queries.
