---
description: Quick idea capture - zero friction, saves to 02.wiki/concepts/ and mentions in daily note
category: vault
...
3. Search `02.wiki/concepts/`, `01.raw/01.Inbox/`, and `02.wiki/**` for a related existing note - if found, append to it
4. If new: create `02.wiki/concepts/Title.md` with minimal frontmatter (`date`, `tags: [idea]`)
5. Write the idea with any supporting context from the conversation
6. Add a brief mention in today's daily note under a Concepts or Captures section
