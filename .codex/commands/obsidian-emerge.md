...
3. Spawn parallel subagents to read vault content from the period:
   ...
   - **Concepts agent**: read `02.wiki/concepts/` notes created in the range, plus raw clues in `01.raw/01.Inbox/` and related `02.wiki/**` notes; look for thematic clusters
...
6. Offer to save the pattern report to `02.wiki/concepts/` or a relevant project note
