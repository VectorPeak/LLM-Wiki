...
3. Create a decision record at `02.wiki/decisions/ADR-YYYY-MM-DD - Title.md`:
...
6. Append to the operation log: write `**HH:MM** - adr | Title - decision recorded` to `Logs/YYYY-MM-DD.md` (create `Logs/` and the daily file if missing; use `.codex/references/log.md` only for the log format)
