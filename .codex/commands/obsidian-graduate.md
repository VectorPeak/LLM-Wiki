...
The optional argument is the idea title, tag, or keyword. If not provided, scan recent notes for ideas tagged `#idea` or in `02.wiki/concepts/`, `01.raw/01.Inbox/`, and `02.wiki/**`, then present them for selection.

1. Read `_CLAUDE.md` first if it exists in the vault root
2. Find the idea to graduate:
   - If argument given: search `02.wiki/concepts/`, `01.raw/01.Inbox/`, `02.wiki/**`, daily notes, and captures for a matching idea (fuzzy match)
...
5. Generate a full project spec:
   - **Project note** in `02.wiki/projects/` with complete frontmatter (date, tags, status: planning, linked idea)
