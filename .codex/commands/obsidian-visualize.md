...
4. Generate a JSON Canvas file (`.canvas`) compatible with Obsidian's native canvas viewer:
   ...
   {
     "nodes": [
       {"id": "1", "type": "file", "file": "02.wiki/entities/Eric Siu.md", "x": 0, "y": 0, "width": 250, "height": 60},
       {"id": "2", "type": "file", "file": "02.wiki/projects/Centralized API Gateway.md", "x": 300, "y": 0, "width": 250, "height": 60}
     ],
     "edges": [
...
7. Append to the operation log: write `**HH:MM** - visualize | Canvas generated - X nodes, Y edges, Z orphans` to `Logs/YYYY-MM-DD.md` (create `Logs/` and the daily file if missing; see `.codex/references/log.md` for the log format)
