自2017年Google推出Transformer以来，基于其架构的语言模型便如雨后春笋般涌现，其中Bert、T5等备受瞩目。Transformer是谷歌在2017年的论文[《Attention Is All You Need》](https://arxiv.org/abs/1706.03762)中提出的，用于NLP的各项任务，现在是谷歌云TPU推荐的参考模型


# Transformer架构


![image.png](https://img.vectorpeak.cn/obsidian/2026/05-06/20260523092621825.png?imageSlim)
