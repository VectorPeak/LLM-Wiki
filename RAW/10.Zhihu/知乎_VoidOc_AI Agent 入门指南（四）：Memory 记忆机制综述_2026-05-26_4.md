---
title: "知乎_VoidOc_知乎文章搜索剪藏_2026-05-26_4"
...
created: 2026-05-26
range: "4"
description: "知乎官方 API 定位，TikHub 补全文，共 6 条，本文件收录第 4 篇。"
tags:
  - "clippings"
  - "zhihu"
  - "VoidOc"
---
## 四、AI Agent 入门指南（四）：Memory 记忆机制综述
...
![image](https://pic4.zhimg.com/v2-557f56499b7137be75190ed496202fdf_1440w.jpg)
...
![image](https://pic1.zhimg.com/v2-a51dbb0ac4b475711385f2f47c48a1bc_1440w.jpg)

智能体记忆 vs. LLM 内部记忆 vs. RAG vs. 上下文工程

**LLM Memory（大语言模型记忆）：**指的是 LLM 自身内部或其架构中实现的记忆机制，主要解决**上下文长度限制**和**长期依赖建模**问题。
...
![image](https://pica.zhimg.com/v2-4dad061cec935baa843dac0c75420a76_1440w.jpg)

![image](https://picx.zhimg.com/v2-897544ef75032eba25ba3035affc3011_1440w.jpg)
...
![image](https://pic1.zhimg.com/v2-2e8cc78837ea51f46f412c7d886773ac_1440w.jpg)
...
![image](https://pic4.zhimg.com/v2-eba65b92ef07e2eb91135a5dbaaffff9_1440w.jpg)
...
![image](https://pic4.zhimg.com/v2-7dcc1a91d7a36e4e928762f16699759f_1440w.jpg)
...
代表性工作有MAC[17]、PersonalityEdit[18]、MEND[19]、KnowledgeEditor[20]等
...
![image](https://pic2.zhimg.com/v2-d4352907d51255f23e3c10920b3bca19_1440w.jpg)
...
![image](https://pic4.zhimg.com/v2-983933bb9ee86fa977b665196ca38667_1440w.jpg)
...
- 实体级构建（Entity-Level Construction）：通过将文本原子化为实体与关系来构建底层拓扑，如KGT、Mem0[21]、GraphRAG、AriGraph、Zep[22]等。
- 片段级构建（Chunk-Level Construction）：通过组织完整的文本片段或记忆项来构建结构，如HAT、RAPTOR、MemTree、SGMem[23]、G-memory等
...
![image](https://pic4.zhimg.com/v2-cc73d29513309dc3aa41c24ff35788af_1440w.jpg)
...
![image](https://pica.zhimg.com/v2-4abf67c7b0924bc3b0ee2d3f9f4572da_1440w.jpg)
...
![image](https://pic3.zhimg.com/v2-b577cfb758b3ad0e74d39fe7158b2e02_1440w.jpg)
...
- **时间与硬件开销（Time & Hardware Cost）：**总时间成本包括**记忆适配时间**（写入+管理）和**推理延迟**（读取）。毕竟再牛的记忆，花2个小时才答上来，也无法落地。
...
![image](https://pica.zhimg.com/v2-04ca5d4fbd3e80bde06c29f9ef0e9d22_1440w.jpg)
